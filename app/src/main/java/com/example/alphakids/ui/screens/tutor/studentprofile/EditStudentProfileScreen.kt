...
fun EditStudentProfileScreen(
    ...
    // Opciones base para los desplegables; se mantienen en memoria para evitar recreaciones.
    val institucionesDisponibles = remember {
        listOf("Institución A", "Institución B", "Otra")
    }
    val gradosDisponibles = remember {
        listOf("Inicial 3 años", "Inicial 4 años", "Inicial 5 años", "1ro", "2do")
    }
    val seccionesDisponibles = remember {
        listOf("A", "B", "C", "D")
    }
